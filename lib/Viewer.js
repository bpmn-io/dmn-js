...
var TableViewer = require('./TableViewer');
...
function Viewer(options) {
  ...
  this.tableViewer = new TableViewer(options);
  this.tableViewer.container.style.display = 'none';
...
Viewer.prototype.importDefinitions = function(definitions, done) {
  if (this.tableViewer) {
    this.tableViewer.importDefinitions(definitions, 0, function() {});
  }
...
Viewer.prototype.showDecision = function(decision, done) {
  ...
  this.tableViewer.container.style.display = 'block';
  return this.tableViewer.showDecision(decision, done);
};

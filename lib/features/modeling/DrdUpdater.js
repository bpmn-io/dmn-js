 ...
 */
function DrdUpdater(eventBus, drdFactory, connectionDocking, drillDown, drdRules) {
...
DrdUpdater.$inject = [ 'eventBus', 'drdFactory', 'connectionDocking', 'drillDown', 'drdRules' ];

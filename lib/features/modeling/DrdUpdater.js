...
function DrdUpdater(eventBus, drdFactory) {
  ...
  this.executed([ 'shape.create' ], updateParent);

  this.reverted([ 'shape.create' ], reverseUpdateParent);
...
DrdUpdater.prototype.updateSemanticParent = function(businessObject, newParent, visualParent) {

...
var ComboBoxView = View.extend({
  ...
  setVisible: function () {
    var visible = this.suggestions.length > 1 || document.activeElement === this.inputEl;
    this.suggestionsEl.style.display = visible ? 'block' : 'none';
  },
  ...
  render: function () {
    ...
    this.renderCollection(this.suggestions, SuggestionView, this.suggestionsEl);

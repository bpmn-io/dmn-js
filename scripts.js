...
var RuleCellView = View.extend(merge({}, ChoiceView.prototype, {
  template: '<td><span class="pseudo-input"></span></td>',

  bindings: merge({}, ChoiceView.prototype.bindings, {
    'model.value': {
      type: 'text',
      selector: '.pseudo-input'
    },
  ...
  _focusPseudo: function () {
    var el = this.pseudoEl || this.query('.pseudo-input[contenteditable]');
    if (!el) {
      return;
    }
...
var ChoiceView = View.extend({
  ...
  initialize: function (options) {
    ...
    this.pseudoEl = this.query('.pseudo-input[contenteditable]') || this.el;

...
// matches bpmn-js's default activity/sub-process fill opacity, so that
// elements rendered underneath a decision service remain visible to some
// degree (cf. bpmn-js/lib/draw/BpmnRenderer.js DEFAULT_OPACITY)

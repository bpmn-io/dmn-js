...
function bootstrapModeler(diagram, options, locals) {
  return bootstrapDmnJS(DecisionTableEditor, diagram, options, locals);
}
...
module.exports.getDecisionTable = (window || global).getDecisionTable = getDecisionTable;

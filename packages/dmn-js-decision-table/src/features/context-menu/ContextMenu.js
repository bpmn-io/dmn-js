      ...
      entries.push(
        <div className="context-menu-group context-menu-group-input">
          ...
          <div
            ...
            { this._translate('Paste Column Left') }
          </div>
          <div
